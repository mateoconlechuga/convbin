...
static uint8_t asm_extractor[] = { 0x21, 0x91, 0xA8, 0xD1, // label to start of extractor section (offset = 1)
                                   0x11, 0x66, 0x94, 0xD0, 0x01, 0xA0, 0x00, 0x00, 0xED, 0xB0, 0xC3, 0x66, 0x94, 0xD0, 0xED, 0x5B, 0x8C, 0x11, 0xD0, 0x21, 0x81, 0xA8, 0xD1, 
                                   0xCD, 0x90, 0x05, 0x02, 0xB7, 0xED, 0x62, 0x22, 0x8C, 0x11, 0xD0,
                                   0x21, 0x00, 0x00, 0x00, // size of uncompressed data (offset = 39)
                                   ...
                                   0x23,
                                   0x11, 0xB4, 0x00, 0x00, // offset to actual data (offset = 84)
                                   0x19,
                                   0x11, 0x7F, 0xA8, 0xD1, // offset to start (offset = 89)
                                   0xCD, 0xB8, 0x94, 0xD0,
                                   0xC3, 0x7F, 0xA8, 0xD1, // offset to start (offset = 97)
                                   0x3E, 0x80, 0xED, 0xA0, 0xCD, 0x00, 0x95, 0xD0, 0x30, 0xF8, 0xD5, 0x11, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x14, 0xCD, 0x00, 0x95, 0xD0,
                                   0x30, 0xF9, 0xD4, 0x00, 0x95, 0xD0, 0xCB, 0x11, 0xCB, 0x10, 0x38, 0x21, 0x15, 0x20, 0xF3, 0x03, 0x5E, 0x23, 0xCB, 0x23, 0x1C, 0x30, 0x0D, 0x16,
                                   0x10, 0xCD, 0x00, 0x95, 0xD0, 0xCB, 0x12, 0x30, 0xF8, 0x14, 0xCB, 0x3A, 0xCB, 0x1B, 0xE3, 0xE5, 0xED, 0x52, 0xD1, 0xED, 0xB0, 0xE1, 0x30, 0xBC,
                                   0x87, 0xC0, 0x7E, 0x23, 0x17, 0xC9,
                                 };
